...
if __name__ == "__main__":
	...
	# that we don't use RDDs at all. Because some of
	# Spark's functions return the same object, we can
	...
	# Note show() is an action, which will trigger the above query executed
